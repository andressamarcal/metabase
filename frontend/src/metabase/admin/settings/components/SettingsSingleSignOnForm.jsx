            ...
            <form noValidate>
                ...
                >
                    ...
                    <p className="text-grey-4">
                        Allows users with existing {t`Metabase`} accounts to login with a Google account that matches their email address in addition to their {t`Metabase`} username and password.
                    </p>
                    <p className="text-grey-4">
