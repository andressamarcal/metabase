...
export default class DeleteQuestionModal extends Component {
  ...
  render() {
    ...
    var dashboardCount =
      this.props.card.dashboard_count +
      " " +
      inflection.inflect("dashboard", this.props.card.dashboard_count);

    return (
      <ModalContent title="Delete Question" onClose={this.props.onClose}>
        <div className="Form-inputs mb4">
          <p>Are you sure you want to do this?</p>
          {this.props.card.dashboard_count > 0 ? (
            <p>
              This question will be deleted from {t`Metabase`}, and will also be
              removed from {dashboardCount}.
            </p>
          ) : null}
        </div>
