...
const AM_PM_OPTIONS = [{ name: "AM", value: 0 }, { name: "PM", value: 1 }];
    ...
    return (
      <div className="mt1">
        ...
        <Select
          ...
          optionValueFn={o => o.value}
          onChange={o =>
            this.props.onPropertyChange("schedule_hour", o + amPm * 12)
          }
        />
        <Select
          ...
          optionValueFn={o => o.value}
          onChange={o =>
            this.props.onPropertyChange("schedule_hour", hour + o * 12)
          }
          className="bg-white"
        />
        <div className="mt2 h4 text-bold text-grey-3 border-top pt2">
          {CHANNEL_NOUN_PLURAL[cs && cs.type] || "Messages"} will be sent at{" "}
          {hour === 0 ? 12 : hour}:00 {amPm ? "PM" : "AM"} {timezone}, your{" "}
          {t`Metabase`} timezone.
        </div>
      </div>
    );
