...
;;
;; Also for this same reason, the database connection for getting the application-name is also not available, this just uses the translated Metabase
;; string until that code has been loaded
